...
def main():
    ...
    all_results_df.to_excel("Complete_result_Spade_1.xlsx", index=False, engine='xlsxwriter', engine_kwargs={'options': {'strings_to_urls': False}})
    ...
    new_format_df.to_excel("Formatted_Result_Spade_1.xlsx", index=False, engine='xlsxwriter', engine_kwargs={'options': {'strings_to_urls': False}})
